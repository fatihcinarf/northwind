...
public class ProductManager implements ProductService {
	...
	@Autowired // Parametreli Constructor
...
//---------------------------------------------------------
	...
	@Override
	public Result postadd(Product product) {
		this.productDao.save(product);
		return new SuccessDataResult<Product>(product, "Ürün eklendi...");
	}
...
//---------------------------------------------------------
	...
	/*
	 * @Override public DataResult<Product> getByProductNameAndCategory(String
	 * productName, int categoryId) { return new SuccessDataResult<Product>(
	 * this.productDao.getByProductNameAndCategory_CategoryId(productName,
	 * categoryId), ": Data listelendi..."); }
	 */
...
//------------------------------------------------------------------------------------------------------------------
	...
	@Override // Sayfa sayısı ve bir sayfada gösterilecek ürün adedi...
	public DataResult<List<Product>> getAll(int pageNo, int pageSize) {
		Pageable pageable = PageRequest.of(pageNo - 1, pageSize);
		return new SuccessDataResult<List<Product>>(this.productDao.findAll(pageable).getContent());
	}

	@Override // Sort.by(Sort.Direction.DESC, "productName") ifadesine göre azalan veya artan
				// şekilde sıralama işlemi yapar
	...
	/*
	 * @Override public DataResult<List<ProductWithCategoryDto>>
	 * getProductWithCategoryDetails() { return new
	 * SuccessDataResult<List<ProductWithCategoryDto>>
